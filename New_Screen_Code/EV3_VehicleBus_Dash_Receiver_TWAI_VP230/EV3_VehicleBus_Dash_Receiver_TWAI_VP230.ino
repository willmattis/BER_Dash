...
void decodeFrame(uint32_t id, const uint8_t *b, uint8_t len) {
  ...
  switch (id) {
    ...
    case 0x6:
      ...
      break;
    case 0x7:
      state.bmsSoc=b[0]*0.392156863f; state.bmsCurrent=b[1]*0.980392f;
      state.bmsMaxCellV=b[2]*0.0098039f+2.0f; state.bmsMaxCellTempC=b[3]*0.2941176f;
      state.bmsMinCellV=b[4]*0.0098039f+2.0f; state.bmsMinCellTempC=b[5]*0.2941176f;
